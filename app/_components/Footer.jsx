    ...
    return (
        <>
            ...
            <div className="relative">
                {/* Chat Window Popup */}
                <div
                    className={`fixed bottom-24 right-6 md:right-8 z-[95] w-[320px] sm:w-[360px] bg-white rounded-2xl shadow-2xl border border-secondary/15 flex flex-col overflow-hidden transition-all duration-300 origin-bottom-right ${isOpen
