    ...
    const fetchCustomer = async () => {
      ...
      try {
        ...
        if (data.success) {
          ...
          alert('Failed to load customer: ' + (data.message || data.error));
        }
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert('Error updating customer: ' + (data.error || data.message));
      }
    } catch (err) {
    ...
    return (
      <>
        ...
        <main className="min-h-screen flex flex-col items-center justify-center bg-surface-container-lowest">
          ...
          <p className="text-body-md text-on-surface-variant font-medium">Loading customer details...</p>
        </main>
      </>
    );
  }
      ...
      <main className="p-0 md:p-lg bg-surface-container-lowest min-h-screen text-on-surface">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <h2 className="text-headline-lg font-headline-lg font-bold">Edit Customer</h2>
            <p className="text-body-md text-on-surface-variant">Update this customer&apos;s profile information</p>
          </div>
