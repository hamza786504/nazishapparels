    ...
    return (
        <section className="py-20 bg-primary text-white relative overflow-hidden">
            <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center">
                ...
                <p className="text-body-lg font-body-lg max-w-lg mx-auto mb-10 text-white/90">
                    Sign up to stay updated with our latest arrivals and exclusive offers delivered
                    straight to your inbox.
                </p>
                <form className="max-w-md mx-auto flex flex-col md:flex-row gap-4 focus-within:ring-1 focus-within:ring-secondary">
                    <input
