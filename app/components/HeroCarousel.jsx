                ...
                {slides.map((slide, index) => (
                    ...
                    >
                        <div className="w-full md:w-[45%] h-1/2 md:h-full flex flex-col justify-center px-margin-mobile md:px-margin-desktop space-y-6 bg-surface-container-low">
                            ...
                            <button className="group flex items-center justify-center gap-3 bg-primary text-on-primary px-10 py-4 font-label-md uppercase tracking-[0.2em] w-fit transition-all duration-300 hover:bg-primary-container hover:scale-[1.02]">
                                EXPLORE COLLECTION
